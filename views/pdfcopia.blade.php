...
.direccion{ text-transform: capitalize; position: absolute;top: 220px; font-size: 14px; margin-left: 25px; font-family: 'Lato', sans-serif;}
...
<p style="position:absolute; color:#fff; top:147px; left:405px; z-index:1; font-size:14px">copia</p>
